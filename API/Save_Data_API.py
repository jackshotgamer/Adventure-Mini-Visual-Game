...
@app.post('/update')
def update_save_file(name: str, pw: str, player_x: int = None, player_y: int = None, hp: int = None, gold: int = None, xp: int = None, lvl: int = None, floor: int = None, deaths: int = None):
    with Database.managed_session() as session:
